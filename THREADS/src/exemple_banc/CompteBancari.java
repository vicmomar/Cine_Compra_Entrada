...
public class CompteBancari {
	...
	public void ingresarEnCuenta (float diners, String nomFil)throws IOException, InterruptedException {
		float aux;
	...
	public void sacarDeCuenta (float diners, String nomFil)throws IOException, InterruptedException {
		float aux;
