...
public class Cine {
	...
	public void compraEntradaPelicula(){
		...
		System.out.println("\tPel·licula escollida:\n"  +pelicula);
		
		// 3.- Selecció de la sessió
		Sessio sessio;
		Sala sala;
		int numSessio, numSala;
